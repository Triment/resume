...
\Large{
  \begin{tabu}{ c l r }
    \multirow{5}{1in}{\includegraphics[width=0.80in]{WechatIMG1}} &  & {Router\&Switch~}\progressbar[ticksheight=0]{0.6} \\
    & \scshape{xx} & {Linux~}\progressbar[ticksheight=0]{0.5} \\
    & \email{} & {Sql}\progressbar[ticksheight=0]{0.4} \\
    & \phone{(+86) } & {Golang~\&web}\progressbar[ticksheight=0]{0.6} \\
    & \github[github.com/triment]{https://github.com/triment} & {数据结构~}\progressbar[ticksheight=0]{0.3}
  \end{tabu}
}
 
\section{\faUsers\ 工作经历}
\datedsubsection{\textbf{} }{2020年3月 -- 至今}
...
\datedsubsection{\textbf{}}{2018年12月 -- 2020年3月}
\role{信息学教师}{教研部}
~\badge[TealBlue]{创意编程比赛一等奖}
\begin{itemize}
...
\datedsubsection{\textbf{}}{2019 -- 2021}
\textit{专科}\ 计算机应用技术
