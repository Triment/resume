...
\Large{
  \begin{tabu}{ c l r }
   \multirow{5}{1in}{\includegraphics[width=0.88in]{avatar}} & \scshape{林帅} & {Python~}\progressbar{0.75} \\
    & \email{yuanbin2014@gmail.com} & {Linux~}\progressbar{0.5} \\
    & \phone{(+86) 131-221-87xxx} & {Go~}\progressbar{0.5} \\
    & \linkedin[billryan8]{https://www.linkedin.com/in/billryan8} & {web}\progressbar{0.5} \\
    & \github[github.com/billryan]{https://github.com/billryan} & {数据结构~}\progressbar{0.3}
  \end{tabu}
}
